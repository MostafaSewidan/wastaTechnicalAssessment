...
<section>
    <div class="container-fluid">
      ...
      <a href="#" data-toggle="modal" data-target="#importdata" class="btn btn-primary add-product-btn"><i class="dripicons-copy"></i> {{__('file.import')}}</a>
    </div>
                    ...
                    <?php
                    	...
                    	foreach ($product_adjustment_data as $key => $product_adjustment) {
                            if($product_adjustment->variant_id) {
                                ...
                                $product = \App\Models\Product::select('name','code')->find($product_adjustment->product_id);
                            }
...
<div id="importdata" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        {!! Form::open(['route' => 'qty_adjustment.importadjustment', 'method' => 'post', 'files' => true]) !!}
           ...
           <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <a href="all-adustment-csv" class="btn btn-info btn-block btn-md"><i class="dripicons-download"></i>  {{trans('file.Download')}}</a>
                    </div>
                </div>
           </div>
