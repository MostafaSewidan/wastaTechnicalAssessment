                            ...
                            <div class="row">
                                ...
                                <div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        ...
                                        <input type="number" name="cost" id="cost_value" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div  class="col-md-4">
                                     <div class="form-group">
                                        <label>{{trans('file.Price Margin')}} *</strong> </label>
                                        <input type="number" id="margin" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" id="price_value" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                    <div class="form-group">
...
<script type="text/javascript">
    ...
    $('#margin').on("keyup", function(){
     ...
     var newprice = parseInt(cost * (margin / 100)) + parseInt(cost);
     $('#price_value').val(newprice);
    ...
    $('#price_value').on("keyup", function(){
     ...
     var addition = parseInt(price) - parseInt(cost);
     var newprice = (addition / cost) * 100;
     $('#margin').val(newprice);
            ...
            this.each(function() {
                ...
                for(i = 0; i < combinations.length; i++) {
                    ...
                    if(oldIndex >= 0) {
                        ...
                        cols += '<td><input type="file" class="form-control item-image" name="item_images[]" /></td>';
                    }
                    else {
