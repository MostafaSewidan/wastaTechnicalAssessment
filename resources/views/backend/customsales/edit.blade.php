        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(['route' => 'customsales.updatesale', 'method' => 'post' ,'class' => 'payment-form', 'files' => 'true']) !!}
                    <div class="container">
                            <div class="row">
                        @php
                                    ...
                                    <div class="table-responsive ml-2">
                                        <table id="variant-table" class="table table-hover order-list">
                                            ...
                                            <tbody id="variant-input-section">
                                                ...
                                                <td><input name="product_name" class="form-control" value="{{ $product->name }}" type="text"/></td>
                                                <td><textarea style="height: 38px;" rows="1" class="form-control" name="product_desc">{{ $product->describtion }}</textarea></td>
                                                <td><input name="product_qty" class="form-control qty" type="number" value="{{ $product->qty }}"/></td>
                                                <td><input name="product_images[]" class="form-control" type="file" multiple accept="image/*" /><br><p class="italic"><small>{{trans('if you upload new images the old images will be deleted and replaced with the new')}}.</small></p></td>
                                                <td></td>
                                            </tr>
                                            @endforeach
                                            </tbody>
...
<!--
                            ...
                            <input type="hidden" name="shipping_cost" value="{{$sale->shipping_cost}}" id="shipping-cost-val">
                                ...
                                <div class="col-12 totals" style="border-top: 2px solid #e4e6fc; padding-top: 10px;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <span class="totals-title">{{trans('file.Shipping')}} <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#shipping-cost-modal"><i class="dripicons-document-edit"></i></button></span><span id="shipping-cost">{{number_format($sale->shipping_cost, $general_setting->decimal, '.', '')}}</span>
                                        </div>
                                        <div class="col-sm-4">
            ...
            <div id="shipping-cost-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="text" name="shipping_cost" value="{{$sale->shipping_cost}}" class="form-control numkey" id="shipping-cost-val" step="any" onkeyup='saveValue(this);'>
                            </div>
...
<script type="text/javascript">
 ...
 $.ajaxSetup({
        headers: {
            ...
            var customer = '<?php echo $sale->customer_id; ?>';
