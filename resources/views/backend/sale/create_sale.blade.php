                                            ...
                                            ?>
                                                ...
                                                <?php
                                                    ...
                                                    if($product_sale->variant_id) {
                                                        $product_variant_data = \App\Models\ProductVariant::select('id', 'item_code')->where([['product_id',$product_data->id], ['variant_id',$product_sale->variant_id]])->orwhere('id',$product_sale->variant_id)->first();
